...
if (document.getElementById("session_logout") != null)
{
    ...
    document.querySelector('nav').innerHTML = '<nav><i href="javascript:void(0)" id="Bars" onclick="menuMobile()" class="fas fa-bars"></i><ul id="Lista_Nav"><li><a id="Goodbikes"href="/">Goodbikes</a></li><li class="ocultoMovil"><a href="/users/login">Login</a></li><li class="ocultoMovil"><a href="/users/register">Registrate</a></li><hr class="ocultoMovil"><li><a href="/products/productSearch/Rodados">Rodados</a></li><li><a href="/products/productSearch/Equipamiento">Equipamiento</a></li><li><a href="/products/productSearch/Indumentaria">Indumentaria</a></li><li><a href="/products/productSearch/Accesorios">Accesorios</a></li><li><a href="/products/productSearch/Taller">Taller</a></li></ul></nav>'
